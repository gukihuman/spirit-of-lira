...
div(class="absolute w-full h-full z-20")
  div(class="flex items-end w-full h-full pb-[170px] pl-[400px]")
    textarea(class="bg-sand-light rounded-3xl text-[28px] z-10 focus:outline-none border-8 border-amber-900 opacity-25 focus:opacity-75 p-6 pt-3 resize-none duration-100 ease-in-out text-bottom selected-text text-[#3a140b] leading-[1.3]" ref="textarea" @input="updateWidth()" placeholder=". . .")
</template>
